...
import com.jg.blog.utils.ThreadLocalContext;
...
public class RequestAspect {
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        Log logger= ThreadLocalContext.get().getLogger();
        logger.setLogStatus(StatusEnums.REQUEST_ERROT.getCode());
    ...
    private void printRequestLog(JoinPoint joinPoint, HttpServletRequest request, String uri) {
        ...
        String paramss =Arrays.toString(joinPoint.getArgs());
        log.info("请求参数",paramss );
        // 获取日志实体
        Log logger= ThreadLocalContext.get().getLogger();
